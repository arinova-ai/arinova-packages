...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="hermes-arinova-live-gate-") as tmp:
        ...
        bad_share_note_partial_marker = hermes_home / "bad-share-note-partial-disconnect.txt"
        bad_share_note_partial = run_live(
            "--hermes-root",
            str(fake_hermes_root),
            ...
            env=clean_env(
                ...
                ARINOVA_SERVER_URL="wss://env.example",
                ARINOVA_BOT_TOKEN="ari_env",
                ARINOVA_FAKE_DISCONNECT_MARKER=str(bad_share_note_partial_marker),
                PYTHONPATH="/definitely/not/hermes",
            ),
        )
        assert_failed(bad_share_note_partial, "SDK shareNote() probe requires both conversation id and note id")
        assert_disconnected(bad_share_note_partial_marker, "bad shareNote partial live smoke")

        bad_share_note_marker = hermes_home / "bad-share-note-disconnect.txt"
        bad_share_note = run_live(
            "--hermes-root",
            str(fake_hermes_root),
            "--share-note-conversation",
            "conv-share",
            ...
            env=clean_env(
                ...
                ARINOVA_SERVER_URL="wss://env.example",
                ARINOVA_BOT_TOKEN="ari_env",
                ARINOVA_FAKE_BAD_SHARE_NOTE="1",
                ARINOVA_FAKE_DISCONNECT_MARKER=str(bad_share_note_marker),
                PYTHONPATH="/definitely/not/hermes",
            ),
        )
        assert_failed(bad_share_note, "SDK shareNote() returned malformed share result")
        assert_disconnected(bad_share_note_marker, "bad shareNote live smoke")

        bad_share_note_missing_tags_marker = hermes_home / "bad-share-note-missing-tags-disconnect.txt"
        bad_share_note_missing_tags = run_live(
            "--hermes-root",
            str(fake_hermes_root),
            "--share-note-conversation",
            "conv-share",
            ...
            env=clean_env(
                ...
                ARINOVA_SERVER_URL="wss://env.example",
                ARINOVA_BOT_TOKEN="ari_env",
                ARINOVA_FAKE_BAD_SHARE_NOTE_MISSING_TAGS="1",
                ARINOVA_FAKE_DISCONNECT_MARKER=str(bad_share_note_missing_tags_marker),
                PYTHONPATH="/definitely/not/hermes",
            ),
        )
        assert_failed(bad_share_note_missing_tags, "SDK shareNote() returned malformed share result")
        assert_disconnected(bad_share_note_missing_tags_marker, "bad shareNote missing tags live smoke")

        bad_share_note_tags_marker = hermes_home / "bad-share-note-tags-disconnect.txt"
        bad_share_note_tags = run_live(
            "--hermes-root",
            str(fake_hermes_root),
            "--share-note-conversation",
            "conv-share",
            ...
            env=clean_env(
                ...
                ARINOVA_SERVER_URL="wss://env.example",
                ARINOVA_BOT_TOKEN="ari_env",
                ARINOVA_FAKE_BAD_SHARE_NOTE_TAGS="1",
                ARINOVA_FAKE_DISCONNECT_MARKER=str(bad_share_note_tags_marker),
                PYTHONPATH="/definitely/not/hermes",
            ),
        )
        assert_failed(bad_share_note_tags, "SDK shareNote() returned malformed share result")
        assert_disconnected(bad_share_note_tags_marker, "bad shareNote tags live smoke")

        bad_share_note_null_tags_marker = hermes_home / "bad-share-note-null-tags-disconnect.txt"
        bad_share_note_null_tags = run_live(
            "--hermes-root",
            str(fake_hermes_root),
            "--share-note-conversation",
            "conv-share",
            ...
            env=clean_env(
                ...
                ARINOVA_SERVER_URL="wss://env.example",
                ARINOVA_BOT_TOKEN="ari_env",
                ARINOVA_FAKE_BAD_SHARE_NOTE_NULL_TAGS="1",
                ARINOVA_FAKE_DISCONNECT_MARKER=str(bad_share_note_null_tags_marker),
                PYTHONPATH="/definitely/not/hermes",
            ),
        )
        assert_failed(bad_share_note_null_tags, "SDK shareNote() returned malformed share result")
        assert_disconnected(bad_share_note_null_tags_marker, "bad shareNote null tags live smoke")
