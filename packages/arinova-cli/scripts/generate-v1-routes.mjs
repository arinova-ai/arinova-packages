...
function authKind(path) {
  ...
  if (path.startsWith("/api/v1/knowledge/")) return "agent";
  if (path === "/oauth/token" || path === "/api/v1/oauth/token") return "public";
  if (path.startsWith("/api/v1/skill-catalog-operator/")) return "catalog-operator";
